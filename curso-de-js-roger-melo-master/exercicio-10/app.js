...
const cat = {
	...
	age: 28,
	color: "black",
	bestFriends: ["Sarana", "leonardo", "victor"],
	sound() {
    return "wooooooof"
  },
};
...
function oneFunction(type) {
	const myObject = {
		null: "Seta, explicitamente, uma variável sem valor.",
		undefined: "Representa um valor não-setado.",
		object: "Arrays, Datas, Objetos literais, Funções, etc.",
	};
   const text = myObject['`${type}`']
}
