...
for (let i = 0; i < fruits.length; i++) {
  ...
  if (element = 'abacaxi') {
    console.log('a tring "abacaxi existe') 
  }
}
...
for (i = 0; i < randomNumbers.length; i++) {
	const isImparOuPar = randomNumbers[i] % 2 == 0 ? isEven() : isOdd();
}
console.log(evenNumbers);
console.log(oddNumbers);

const [n1, n2, n3] = evenNumbers
const [on1, on2, on3] = oddNumbers
console.log(`Numeros ímpares: ${on1}, ${on2} e ${on3}. Números pares: ${n1}, ${n2} e ${n3}.`)
