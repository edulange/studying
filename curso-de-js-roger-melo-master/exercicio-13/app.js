...
const getCatInfo = () => {
  ...
  let age = 3
  const color = 'Cinza'
  globalThis.infos = console.log(`${name} é um gato ${color} de ${age} anos.`)
}
getCatInfo()
...
const newCrazyArray = crazyArray.shift()
console.log(newCrazyArray)
...
console.log(dogs.find( element => element.name === "Zequinha"))
