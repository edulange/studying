...
function bestMovies(array) {
	console.log(`${array.title}, dirigido por ${array.directedBy}`);
}
...
console.log(`${youtubeUser.videos.recentVideos[1].title}`);
console.log(`${youtubeUser.videos.recentVideos[2].title}`);
...
window.onload = console.log(randomNumber);
