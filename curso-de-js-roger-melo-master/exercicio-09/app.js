...
const arrowConvertToString = (value) => {
	return String(value);
};
...
*/
const howManyChar = (value) => {
	return value.length;
};
// console.log(howManyChar('olá'))
...
*/
let frase = "CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO";
const toLowerChar = (stringInput) => {
	fraseToLower = stringInput.toLowerCase();
	console.log(fraseToLower);
};
toLowerChar(frase);
...
const indexOfChar = (character, string) => {
	...
	console.log(`O caractér '${character}' se encontra na posição ${position}`);
};
indexOfChar("a", "babaca");
...
*/
const testArray = [1, 2, "olá", 1];
const thereIsInTheArray = (item, array) => {
...
thereIsInTheArray("olá", testArray);
...
const concArrays = (array1, array2) => {
	array3 = array1.concat(array2);
	console.log(array3);
};
concArrays(["olá", "vamos", 2], ["tudo", "embora"]);
...
const removeLastItemArray = (arrayToRemove) => {
	arrayToRemove.pop();
	console.log(arrayToRemove);
};
console.log(removeLastItemArray([2, 3, 4]));
