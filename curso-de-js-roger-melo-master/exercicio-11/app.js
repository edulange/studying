...
const car = {
  ...
  run() {
    this.isRunning = true;
    return console.log(`O ${car.name} está em movimento`)
  },
  stop() {
    this.isRunning = false;
    return console.log(`O ${car.name} está parado`)
  },
  getColorsMessage() {
    return console.log(`O ${car.name} está disponível nas cores ${car.colors[0]}, ${car.colors[1]} e ${car.colors[2]}`)
  }
}
